...
def dateparts(ds):
    ...
    ----------
    ds : pandas.Series
        Series having the datetime column.
    ...
    date_features = pd.DataFrame()
    try:
        fyear = pd.Series(ds.dt.year, name='year')
        fmonth = pd.Series(ds.dt.month, name='month')
        fday = pd.Series(ds.dt.day, name='day')
        fdow = pd.Series(ds.dt.dayofweek, name='dayofweek')
...
def timeparts(ds):
    ...
    try:
        fhour = pd.Series(ds.dt.hour, name='year')
        fminute = pd.Series(ds.dt.minute, name='month')
        fsecond = pd.Series(ds.dt.second, name='day')

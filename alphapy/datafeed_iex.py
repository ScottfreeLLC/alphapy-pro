...
# First example: get one month of Historical Daily prices for international symbols. 
symbol_param = 'BYG-LN' 
range_param = '1m' 
...
print(f'API Call: {api_call}') # The resulting API call should be: https://sandbox.iexapis.com/stable/stock/BYG-LN/chart/1m?token={token}} 
...
# Chart - most recent close price 
last_date = data[-1]['date'] 
last_close = data[-1]['close'] 
print(f'Price for {symbol_param} on {last_date} was {last_close}') 
...
endpoint_path = f'stock/{symbol_param}/stats' # https://sandbox.iexapis.com/stable/stock/JNJ/stats?token={token} 
# Endpoint_path = f'stock/{symbol_param}/stats/{field_param}' # https://sandbox.iexapis.com/stable/stock/JNJ/stats/marketcap?token={token} 
